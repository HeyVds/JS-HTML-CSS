// exercicio 1
const ex01CondJs = document.querySelector("#ex-cond-01")
ex01CondJs.addEventListener('click', ()=>{
...
const ex02CondJs = document.querySelector("#ex-cond-02")
ex02CondJs.addEventListener('click', ()=>{
    ...
    if (sexo === "f" && estado_civil === "casada") {
        tempo = Number(prompt("Casada há quanto tempo? (em anos)"));
        alert (`Nome: ${nome}, Sexo: ${sexo}, Estado Civil: ${estado_civil}, Tempo de casada: ${tempo}.`)
    } else{
        alert (`Nome: ${nome}, Sexo: ${sexo}, Estado Civil: ${estado_civil}.`)
    }
})

// exercício 3
const ex03CondJs = document.querySelector("#ex-cond-03")
ex03CondJs.addEventListener('click', ()=>{
...
const ex04CondJs = document.querySelector("#ex-cond-04")
ex04CondJs.addEventListener('click', ()=>{
    const a = Number(prompt("Digite o primiero valor: "));
    const b = Number(prompt("Digite o segundo valor: "));
    
    if (a === b){
        alert(`Os valores são iguais, então a soma deles é = ${a+b}`);
    } else{
        alert(`Os valores são diferentes, então o produto deles é = ${a*b}`);
    }
})
